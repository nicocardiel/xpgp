...
C caracteristicas de los simbolos
	...
	CALL BUTTON(43,'current height',0)
	CALL BUTTON(43,'current height',3)
...
C
	      ...
	      DO WHILE(NB__.EQ.0)
	        ...
	        ELSEIF(NB__.EQ.30)THEN
	          WRITE(*,*)
	          WRITE(CDUMMY,*) NCOLORBUFF(NB_)
	          WRITE(*,100) 'New CI for symbols '
	          NCOLORBUFF(NB_)=READI_B(CDUMMY)
	          WRITE(77,*) NCOLORBUFF(NB_)
	        ELSE
	          NB__=0
	        END IF
	      END DO
...
C..............................................................................
	  ELSEIF(NB.EQ.43)THEN
	    WRITE(77,'(I3.3,10X,A)') NB,'<current height>'
	    CALL BUTTON(43,'current height',5)
C
	    CALL ONLYONE(NB_)
	    IF(NB_.EQ.-1)THEN
	      WRITE(*,101) 'ERROR: you must activate at least one '//
     >         'buffer.'
	    ...
	    ELSE
	      ...
	      END IF
C
	      WRITE(*,100) 'Select current height...'
...
C
	      ...
	      ELSEIF(NSYMBBUFF(NB_).EQ.7)THEN
	        CALL BUTTON(25,'\7',1)
	      ELSEIF(NSYMBBUFF(NB_).EQ.9)THEN
	        CALL BUTTON(26,'\11',1)
	      ...
	      ELSEIF(NSYMBBUFF(NB_).EQ.18)THEN
	        CALL BUTTON(35,'\22',1)
	      ELSEIF(NSYMBBUFF(NB_).EQ.19)THEN
	        CALL BUTTON(36,'\23',1)
...
C..............................................................................
	  ELSEIF(NB.EQ.135)THEN
	    ...
	    XOPT=READC_B(XOPT,'ABCGILNPMTSV120')
...
C..............................................................................
	  ELSEIF(NB.EQ.136)THEN
	    ...
	    YOPT=READC_B(YOPT,'ABCGILNPMTSV120')
